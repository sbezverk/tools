...
//
// Based on CiscoDevNet nx-telemetry-proto adjacency schema.
// ----------------------------------------------------------------------------
...
const (
	AdjacencyAddressFamily_ADJACENCY_ADDRESS_FAMILY_UNKNOWN AdjacencyAddressFamily = 0
	AdjacencyAddressFamily_ADJACENCY_ADDRESS_FAMILY_IPV4    AdjacencyAddressFamily = 1
	AdjacencyAddressFamily_ADJACENCY_ADDRESS_FAMILY_IPV6    AdjacencyAddressFamily = 2
)

// Enum value maps for AdjacencyAddressFamily.
var (
	AdjacencyAddressFamily_name = map[int32]string{
		0: "ADJACENCY_ADDRESS_FAMILY_UNKNOWN",
		1: "ADJACENCY_ADDRESS_FAMILY_IPV4",
		2: "ADJACENCY_ADDRESS_FAMILY_IPV6",
	}
	AdjacencyAddressFamily_value = map[string]int32{
		"ADJACENCY_ADDRESS_FAMILY_UNKNOWN": 0,
		"ADJACENCY_ADDRESS_FAMILY_IPV4":    1,
		"ADJACENCY_ADDRESS_FAMILY_IPV6":    2,
	}
)
...
type NxAdjacencyProto struct {
	...
	AddressFamily AdjacencyAddressFamily `protobuf:"varint,8,opt,name=address_family,json=addressFamily,proto3,enum=adjacency.AdjacencyAddressFamily" json:"address_family,omitempty"`
	// Adjacency event type
	EventType AdjacencyEventType `protobuf:"varint,9,opt,name=event_type,json=eventType,proto3,enum=adjacency.AdjacencyEventType" json:"event_type,omitempty"`
	// Timestamp
...
func (x *NxAdjacencyProto) GetAddressFamily() AdjacencyAddressFamily {
	...
	return AdjacencyAddressFamily_ADJACENCY_ADDRESS_FAMILY_UNKNOWN
}
...
var file_adjacency_proto_rawDesc = []byte{
	...
	0x6f, 0x12, 0x09, 0x61, 0x64, 0x6a, 0x61, 0x63, 0x65, 0x6e, 0x63, 0x79, 0x22, 0xc6, 0x03, 0x0a,
	0x10, 0x4e, 0x78, 0x41, 0x64, 0x6a, 0x61, 0x63, 0x65, 0x6e, 0x63, 0x79, 0x50, 0x72, 0x6f, 0x74,
	...
	,
	...
	,
}
...
var file_adjacency_proto_goTypes = []any{
	(AdjacencyAddressFamily)(0), // 0: adjacency.AdjacencyAddressFamily
	(AdjacencyEventType)(0),     // 1: adjacency.AdjacencyEventType
	(*NxAdjacencyProto)(nil),    // 2: adjacency.NxAdjacencyProto
}
var file_adjacency_proto_depIdxs = []int32{
	0, // 0: adjacency.NxAdjacencyProto.address_family:type_name -> adjacency.AdjacencyAddressFamily
	1, // 1: adjacency.NxAdjacencyProto.event_type:type_name -> adjacency.AdjacencyEventType
